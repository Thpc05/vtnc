...
Singleton {
    ...
    readonly property string ipcControlCenterTarget: "controlcenter"
    ...
    readonly property bool autoHideShowOnControlCenter: d.autoHideShowOnControlCenter
    ...
    FileView {
        ...
        adapter: JsonAdapter {
            ...
            property bool autoHideShowOnControlCenter: Defaults.config.autoHideShowOnControlCenter
