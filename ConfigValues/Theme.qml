...
//  (apps, OSDs, control center, reveals). A casca da ilha — raio, margem,
...
Singleton {
    ...
    // (o FADE TARDIO saiu com a control center: era ela que precisava de um
    ...
    // Respiro dentro de um card (widget da control center)
    readonly property real cardPadding: d.cardPadding
    // Tamanho que os apps pedem quando abrem
    readonly property real controlWidth: d.controlWidth
    ...
    // os sliders, 0.72 — ver ControlCenter/ControlCenter.qml
    readonly property real controlCardHeight: d.controlCardHeight
    readonly property real controlGap: d.controlGap
    ...
    FileView {
        ...
        adapter: JsonAdapter {
            ...
            property real controlWidth: Defaults.theme.controlWidth
            ...
            // control center
            property real controlCardHeight: Defaults.theme.controlCardHeight
            property real controlGap: Defaults.theme.controlGap
