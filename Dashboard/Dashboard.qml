...
//
//  Registrar um widget = criar em Dashboard/Widgets/ +
...
Item {
    ...
    // ═══════════════════════════════════
    MediaWidget     { id: wMedia; gridCol: 0; gridRow: 0 }
    NetworkWidget   { id: wNet;   gridCol: 4; gridRow: 0 }
    BluetoothWidget { id: wBt;    gridCol: 6; gridRow: 0 }
    CalendarWidget  { id: wCal;   gridCol: 0; gridRow: 1 }
    VolumeWidget    { id: wAudio; gridCol: 4; gridRow: 1 }
}
