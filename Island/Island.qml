...
//  (IslandFace) são plugadas via `faces` pelo shell.qml e podem ser
...
Item {
    ...
    SequentialAnimation {
        ...
        ParallelAnimation {
            NumberAnimation {
                ...
                property: "opacity"
                to: 0
                duration: IslandTheme.faceFadeOut
                easing.type: Easing.InQuad
            }
            NumberAnimation {
                target: faceHost
                property: "scale"
                to: IslandTheme.faceScaleOut
                duration: IslandTheme.faceFadeOut
                easing.type: Easing.InQuad
            }
        }
        ...
        ScriptAction {
            script: {
                ...
                faceHost.scale = IslandTheme.faceScaleIn
            }
        }
        // 3. espera a borda chegar perto do destino
        PauseAnimation { duration: IslandTheme.faceFadeInDelay }
        ...
        ParallelAnimation {
            NumberAnimation {
                ...
                property: "opacity"
                to: 1
                duration: IslandTheme.faceFadeIn
    ...
    Rectangle {
        ...
        width: root.activeFace ? root.activeFace.contentWidth : IslandTheme.width
        height: root.activeFace ? root.activeFace.contentHeight : IslandTheme.height
        ...
        // isso o raio é sempre IslandTheme.radius
        radius: Math.min(Math.max(0, height) / 2, IslandTheme.radius)
        ...
        Behavior on width {
            ...
            Settle { duration: IslandTheme.morphDuration }
        }
        Behavior on height {
            enabled: root.morphing
            Settle { duration: IslandTheme.morphDuration }
