...
//  tempos do morph — mora em Island/IslandTheme.qml.
//
...
QtObject {
    ...
    //  A escala de movimento é do Config/Motion.qml (durações +
    //  assentamento) e os dois componentes de animação são o Settle
    //  (forma) e o Smooth (posição/opacidade).
    //  A coreografia do morph, essa é da ilha: Island/IslandTheme.qml.
    // ════════════════════════════════════════
    ...
    //  da altura da barra (IslandTheme.height / 2 = 16). Acima disso a
